...
declare -A expected_decision_hashes=(
    ...
    [D-011]='8605cbd22a332ccd315612c52d8886b70f7dd697d23358f3448b83c50cbc4f9b'
...
require_text docs/PROJECT_PROGRESS.md 'P2-001–P2-009A 与 P2-009B1/B2 有界切片 Verified'
...
require_text docs/PROJECT_CURRENT_STATE.md 'private 1.3'

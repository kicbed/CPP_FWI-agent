...
require_text docs/PROJECT_CURRENT_STATE.md '当前约 4 个，P2 为 0'
require_text docs/PROJECT_CURRENT_STATE.md 'P0、P1、P2'
require_text docs/PROJECT_CURRENT_STATE.md '完整故障回归和代表性 CPU/CUDA HTTP/SSE E2E'
require_text docs/PROJECT_CURRENT_STATE.md 'P3–P6 仍按固定顺序 Pending'

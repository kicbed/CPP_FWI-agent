...
require_text docs/PROJECT_CONTINUITY.md 'P2-009B1 首次启动失败重试 Verified'
...
require_text docs/PROJECT_PROGRESS.md 'P2-009B1 pre-running launch failure 重试 Verified'
require_text docs/PROJECT_PROGRESS.md 'Runtime 343/343'

...
class ScientificRuntimeRegistryTest(unittest.TestCase):
    ...
    def test_fresh_v20_has_all_migration_checksums_and_task_discovery_index(self) -> None:
        ...
        self.assertEqual(
            ...
            [
                ...
                (15, "0015_worker_exit_retry.sql"),
                (16, "0016_dispatch_negative_reconciliation.sql"),
                (17, "0017_checkpoint_wait_resume.sql"),
                (18, "0018_dag_node_claim_candidates.sql"),
                (19, "0019_dag_node_input_bindings.sql"),
                (20, "0020_dag_node_execution_kernel.sql"),
                (21, "0021_dag_runtime_scheduler.sql"),
                (22, "0022_dag_node_cache_lineage.sql"),
                (23, "0023_fixed_recipe_parallel_admission.sql"),
            ],
        )
    ...
    def test_packaged_algorithm_upgrade_preserves_legacy_parameter_policy(self) -> None:
        ...
        previous_reconciliation = load_deepwave_manifest("1.5.0")
        ...
        self.assertEqual(previous_reconciliation["version"], "1.5.0")
        self.assertEqual(previous_reconciliation["adapter"]["version"], "1.5.0")
        self.assertEqual(current["version"], "1.6.0")
        self.assertEqual(
            current_hash,
        ...
        self.assertEqual(current["adapter"]["version"], "1.6.0")
        self.assertEqual(
            current["outputs"],
            [
        ...
        reopened.register_algorithm(manifest=previous_reconciliation)
    ...
    def test_iteration_policy_is_bound_to_algorithm_version(self) -> None:
        ...
        current_draft["algorithm"]["version"] = "1.6.0"
    ...
    def test_packaged_fwi_snapshot_is_schema_valid_and_path_free(self) -> None:
        ...
        self.assertEqual(manifest["adapter"]["version"], "1.6.0")
...
class ScientificRuntimeV1UpgradeTest(unittest.TestCase):
    ...
    def test_concurrent_v1_upgrade_converges_without_duplicate_backfill(self) -> None:
        ...
        self.assertEqual(results, [(23, approval["approval_id"])] * 8)
        connection = sqlite3.connect(self.database_path)
        try:
            self.assertEqual(
                connection.execute(

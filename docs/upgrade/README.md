...
Next session should continue v0.15 Internal Sanity-Check Runner Gate. Do not
execute commands, read credentials, create directories, delete files, move files,
or connect real execution by default.

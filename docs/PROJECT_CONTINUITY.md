...
- 决策状态：**Accepted**
- 实现状态：**P0 + P1.1c atomic submit backend + P1.2a fixed Adapter Verified / P1 Guided Web pending**
- 用户确认日期：2026-07-15
...
- 尚未实现：部署审批/任务 API、Guided Web、Adapter status/collect 产品轮询与结果卡、P2
  cancel/lease/retry/自动 reconciliation/SSE、P3 DAG、Agent Planner、通用 Algorithm SDK 和
  去噪链路。
